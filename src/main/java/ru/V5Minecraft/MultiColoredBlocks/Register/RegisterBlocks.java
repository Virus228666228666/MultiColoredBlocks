...
import ru.V5Minecraft.MultiColoredBlocks.blocks.Fence;
...
public class RegisterBlocks {
    ...
    public static final RegistryObject<Block> RedPlanks = BLOCKS.register("red_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> OrangePlanks = BLOCKS.register("orange_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> YellowPlanks = BLOCKS.register("yellow_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> GreenPlanks = BLOCKS.register("green_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> LightBluePlanks = BLOCKS.register("lightblue_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> BluePlanks = BLOCKS.register("blue_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> PurplePlanks = BLOCKS.register("purple_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> BlackWhitePlanks = BLOCKS.register("black_white_planks", () -> new Block(AbstractBlock.Properties.copy(OAK_PLANKS)));
    ...
    public static final RegistryObject<Block> RedOakLog = BLOCKS.register("red_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> OrangeOakLog = BLOCKS.register("orange_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> YellowOakLog = BLOCKS.register("yellow_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> GreenOakLog = BLOCKS.register("green_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> LightBlueOakLog = BLOCKS.register("lightblue_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> BlueOakLog = BLOCKS.register("blue_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> PurpleOakLog = BLOCKS.register("purple_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> BlackWhiteOakLog = BLOCKS.register("black_white_oak_log", () -> log(MaterialColor.WOOD, MaterialColor.PODZOL));
    ...
    public static final RegistryObject<Block> RedIronBars = BLOCKS.register("red_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> OrangeIronBars = BLOCKS.register("orange_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> YellowIronBars = BLOCKS.register("yellow_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> GreenIronBars = BLOCKS.register("green_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> LightBlueIronBars = BLOCKS.register("lightblue_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> BlueIronBars = BLOCKS.register("blue_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> PurpleIronBars = BLOCKS.register("purple_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> BlackWhiteIronBars = BLOCKS.register("black_white_iron_bars", () -> new PaneBlock(AbstractBlock.Properties.copy(IRON_BARS)));
    ...
    public static final RegistryObject<Block> RedDoor = BLOCKS.register("red_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> OrangeDoor = BLOCKS.register("orange_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> YellowDoor = BLOCKS.register("yellow_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> GreenDoor = BLOCKS.register("green_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> LightBlueDoor = BLOCKS.register("lightblue_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> BlueDoor = BLOCKS.register("blue_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> PurpleDoor = BLOCKS.register("purple_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> BlackWhiteDoor = BLOCKS.register("black_white_wooden_door", () -> new DoorBlock(AbstractBlock.Properties.copy(OAK_DOOR)));
    ...
    public static final RegistryObject<Block> RedPressurePlate = BLOCKS.register("red_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> OrangePressurePlate = BLOCKS.register("orange_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> YellowPressurePlate = BLOCKS.register("yellow_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> GreenPressurePlate = BLOCKS.register("green_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> LightBluePressurePlate = BLOCKS.register("lightblue_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> BluePressurePlate = BLOCKS.register("blue_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> PurplePressurePlate = BLOCKS.register("purple_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> BlackWhitePressurePlate = BLOCKS.register("black_white_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> RedFence = BLOCKS.register("red_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> OrangeFence = BLOCKS.register("orange_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> YellowFence = BLOCKS.register("yellow_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> GreenFence = BLOCKS.register("green_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> LightBlueFence = BLOCKS.register("lightblue_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> BlueFence = BLOCKS.register("blue_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> PurpleFence = BLOCKS.register("purple_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> BlackWhiteFence = BLOCKS.register("black_white_fence", () -> new Fence(AbstractBlock.Properties.copy(OAK_FENCE)));
    ...
    public static final RegistryObject<Block> RedLadder = BLOCKS.register("red_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> OrangeLadder = BLOCKS.register("orange_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> YellowLadder = BLOCKS.register("yellow_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> GreenLadder = BLOCKS.register("green_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> LightBlueLadder = BLOCKS.register("lightblue_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> BlueLadder = BLOCKS.register("blue_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> PurpleLadder = BLOCKS.register("purple_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> BlackWhiteLadder = BLOCKS.register("black_white_ladder", () -> new LadderBlock(AbstractBlock.Properties.copy(LADDER)));
    ...
    public static final RegistryObject<Block> RedTrapDoor = BLOCKS.register("red_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> OrangeTrapDoor = BLOCKS.register("orange_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> YellowTrapDoor = BLOCKS.register("yellow_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> GreenTrapDoor = BLOCKS.register("green_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> LightBlueTrapDoor = BLOCKS.register("lightblue_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> BlueTrapDoor = BLOCKS.register("blue_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> PurpleTrapDoor = BLOCKS.register("purple_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> BlackWhiteTrapDoor = BLOCKS.register("black_white_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.copy(OAK_TRAPDOOR)));
