...
public class PurpleFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public PurpleFurnaceTileEntity() {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                PurpleFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
