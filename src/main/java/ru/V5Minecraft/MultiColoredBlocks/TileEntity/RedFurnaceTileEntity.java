...
public class RedFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                RedFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
