...
public class BlueFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                BlueFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
