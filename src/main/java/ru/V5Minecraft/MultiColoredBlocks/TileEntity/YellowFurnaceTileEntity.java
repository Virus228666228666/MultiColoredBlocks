...
public class YellowFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public YellowFurnaceTileEntity() {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                YellowFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
