package ru.V5Minecraft.MultiColoredBlocks.TileEntity;
...
import ru.V5Minecraft.MultiColoredBlocks.Enum.FurnaceType;
import ru.V5Minecraft.MultiColoredBlocks.blocks.*;

import javax.annotation.Nullable;
import java.util.Iterator;

public class LightBlueFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public LightBlueFurnaceTileEntity() {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                LightBlueFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
