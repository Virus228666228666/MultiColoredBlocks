...
public class PurpleFurnace extends BlockContainer {
    public static final PropertyDirection FACING;
    private final boolean isBurning;
    private static boolean keepInventory;

    public PurpleFurnace(String name, boolean isBurning) {
        super(Material.ROCK);
    ...
    public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
        return new ItemStack(RegisterBlocks.PurpleFurnace);
    }

    public Item getItemDropped(IBlockState p_180660_1_, Random p_180660_2_, int p_180660_3_) {
        return Item.getItemFromBlock(RegisterBlocks.PurpleFurnace);
    }
    ...
    public boolean onBlockActivated(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumHand p_180639_5_, EnumFacing p_180639_6_, float p_180639_7_, float p_180639_8_, float p_180639_9_) {
        if (p_180639_1_.isRemote) {
            ...
            if (lvt_10_1_ instanceof PurpleFurnaceTileEntity) {
                p_180639_4_.displayGUIChest((PurpleFurnaceTileEntity)lvt_10_1_);
    ...
    public static void setState(boolean p_176446_0_, World p_176446_1_, BlockPos p_176446_2_) {
        ...
        keepInventory = true;
        if (p_176446_0_) {
            p_176446_1_.setBlockState(p_176446_2_, RegisterBlocks.PurpleFurnaceOn.getDefaultState().withProperty(FACING, lvt_3_1_.getValue(FACING)), 3);
            p_176446_1_.setBlockState(p_176446_2_, RegisterBlocks.PurpleFurnaceOn.getDefaultState().withProperty(FACING, lvt_3_1_.getValue(FACING)), 3);
        } else {
            p_176446_1_.setBlockState(p_176446_2_, RegisterBlocks.PurpleFurnace.getDefaultState().withProperty(FACING, lvt_3_1_.getValue(FACING)), 3);
            p_176446_1_.setBlockState(p_176446_2_, RegisterBlocks.PurpleFurnace.getDefaultState().withProperty(FACING, lvt_3_1_.getValue(FACING)), 3);
        }
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new PurpleFurnaceTileEntity();
    }
    ...
    public void onBlockPlacedBy(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
        ...
        if (p_180633_5_.hasDisplayName()) {
            ...
            if (lvt_6_1_ instanceof PurpleFurnaceTileEntity) {
                ((PurpleFurnaceTileEntity)lvt_6_1_).setCustomInventoryName(p_180633_5_.getDisplayName());
            }
        }
    ...
    public void breakBlock(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_) {
        if (!keepInventory) {
            ...
            if (lvt_4_1_ instanceof PurpleFurnaceTileEntity) {
                InventoryHelper.dropInventoryItems(p_180663_1_, p_180663_2_, (PurpleFurnaceTileEntity)lvt_4_1_);
